...
////// ONGLET 2 ////////
// Table des types de la Génération 9 (complète)
const typeChart = {
    normal: {rock: 0.5, ghost: 0, steel: 0.5, fighting: 1, fairy: 1, dark: 1, ice: 1, fire: 1, water: 1, grass: 1, electric: 1, bug: 1, poison: 1, flying: 1, ground: 1, dragon: 1, normal: 1, psychic: 1,},
    fire: {fire: 0.5, water: 0.5, grass: 2, ice: 2, bug: 2, rock: 0.5, dragon: 0.5, steel: 2, ghost: 1, fighting: 1, fairy: 1, normal: 1, dark: 1, ground: 1, psychic: 1, flying: 1, electric: 1, poison: 1,},
    water: {fire: 2, water: 0.5, grass: 0.5, ground: 2, rock: 2, dragon: 0.5, ghost: 1, fighting: 1, fairy: 1, normal: 1, dark: 1, electric: 1, poison: 1, bug: 1, ice: 1, flying: 1, steel: 1, psychic: 1,},
    grass: {fire: 0.5, water: 2, grass: 0.5, poison: 0.5, ground: 2, flying: 0.5, bug: 0.5, rock: 2, dragon: 0.5, steel: 0.5, fairy: 1, ghost: 1,fighting: 1,normal: 1,dark: 1,electric: 1,ice: 1, psychic: 1,},
    electric: {electric: 0.5, flying: 2, water: 2, ground: 0, dragon: 0.5, ghost: 1, fighting: 1, fairy: 1, normal: 1, dark: 1, fire: 1, grass: 0.5, ice: 1, steel: 1, bug: 1,poison: 1, psychic: 1, rock: 1,},
    ice: {fire: 0.5, ice: 0.5, steel: 0.5, water: 0.5, grass: 2, ground: 2, flying: 2, dragon: 2,  ghost: 1, fighting: 1, fairy: 1, normal: 1, dark: 1, electric: 1, poison: 1, bug: 1, psychic: 1, rock: 1,},
    fighting: {normal: 2,ice: 2, rock: 2, dark: 2, steel: 2, flying: 0.5, psychic: 0.5, fairy: 0.5, ghost: 0, dragon: 1, fire: 1, water: 1, grass: 1, electric: 1, poison: 0.5, bug: 0.5, fighting: 1, ground: 1,},
    poison: {grass: 2, fairy: 2, poison: 0.5, ground: 0.5, rock: 0.5, ghost: 0.5, fighting: 1, normal: 1, ice: 1, fire: 1, water: 1, electric: 1, bug: 1, dragon: 1, steel: 0, dark: 1, psychic: 1, flying: 1,},
    ground: { fire: 2, rock: 2, steel: 2, electric: 2, poison: 2, grass: 0.5, bug: 0.5, water: 1,  ghost: 1, fighting: 1, fairy: 1, normal: 1, ice: 1, dragon: 1, dark: 1, psychic: 1, ground: 0, flying: 0,},
    flying: { fighting: 2, bug: 2, grass: 2, electric: 0.5, rock: 0.5, steel: 0.5, ghost: 1, fairy: 1, normal: 1, ice: 1, fire: 1, water: 1, poison: 1, ground: 1, dark: 1, dragon: 1, psychic: 1, flying: 1, },
    psychic: { fighting: 2, poison: 2, psychic: 0.5, bug: 1, ghost: 1, dark: 0, fairy: 1, normal: 1, ice: 1, fire: 1, water: 1, grass: 1, electric: 1, rock: 1, steel: 0.5, ground: 1, dragon: 1, flying: 1,},
    bug: { grass: 2, psychic: 2, dark: 2, fire: 0.5, fighting: 0.5, flying: 0.5, ghost: 0.5, fairy: 0.5, steel: 0.5, rock: 1, dragon: 1, water: 1, electric: 1, poison: 0.5, ground: 1, ice: 1, bug: 1, normal: 1,},
    rock: { fighting: 0.5, steel: 0.5, ground: 0.5, normal: 1, fire: 2, flying: 2, bug: 2, ice: 2, poison: 1, ghost: 1, dark: 1, dragon: 1, fairy: 1, electric: 1, water: 1, grass: 1, psychic : 1, rock: 1,},
    ghost: { normal: 0, fighting: 1, poison: 1, bug: 1, ghost: 2, dark: 0.5, fairy: 1, steel: 1, rock: 1, ice: 1, fire: 1, water: 1, grass: 1, electric: 1, dragon: 1, psychic: 2, ground: 1, flying: 1,},
    dragon: { dragon: 2, steel: 0.5, fairy: 0, ghost: 1, fighting: 1, poison: 1, bug: 1, rock: 1, normal: 1, ice: 1, fire: 1, water: 1, grass: 1, electric: 1, dark: 1, flying: 1, ground: 1, psychic: 1,},
    dark: {ghost: 2, psychic: 2, fighting: 0.5, dark: 0.5, fairy: 0.5, steel: 1, rock: 1, normal: 1, ice: 1, fire: 1, water: 1, grass: 1, electric: 1, poison: 1, bug: 1, ground: 1, dragon: 1, flying: 1,},
    steel: { normal: 1, fire: 0.5, water: 0.5, electric: 0.5, ice: 2, rock: 2, fairy: 2, ghost: 1, fighting: 1, poison: 1, bug: 1, ground: 1, dark: 1, dragon: 1, grass: 1, psychic: 1, steel: 0.5, flying: 1,},
    fairy: { fighting: 2, dark: 2, dragon: 2, steel: 0.5, poison: 0.5, ghost: 1, bug: 1, ice: 1, water: 1, fire: 0.5, electric: 1, grass: 1, normal: 1, rock: 1, ground: 1, flying: 1, fairy: 1, psychic: 1,},
};

function calculateTypeEffectiveness(attackType, defenseType1, defenseType2 = '') {
    let multiplier = 1;

    // Vérifier si le premier type défensif est immunisé
    if (typeChart[attackType] && typeChart[attackType][defenseType1] === 0) {
        return 0; // Immunité totale
    }

    // Vérifier si le deuxième type défensif est immunisé
    if (defenseType2 && typeChart[attackType] && typeChart[attackType][defenseType2] === 0) {
        return 0; // Immunité totale
    }
